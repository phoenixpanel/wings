...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"phoenixpanel_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"phoenixpanel_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the phoenixpanel containers are started with user namespace
	// remapping disabled
