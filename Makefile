...
debug:
	go build -ldflags="-X github.com/phoenixpanel/wings/system.Version=1.0.0"
...
rmdebug:
	go build -gcflags "all=-N -l" -ldflags="-X github.com/phoenixpanel/wings/system.Version=1.0.0" -race
